      ...
      <section className="text-container">
        <div className="about-text">
          ...
          <p>We're thrilled that you've found your way to our page. Typpr started as a passion project and has evolved
            into
            a powerful tool for anyone looking to enhance their typing skills and track their progress.</p><br/>
          <h1>About Us</h1>
          <p>At Typpr, we believe in the power of typing as an essential skill in the modern world. Our goal is to
            assist
            users in improving their typing skills in an engaging and enjoyable way while tracking their progress.</p>
        </div>
        <div className="about-text">
          <h1>What We Offer</h1>
          ...
          <p>Discover your typing proficiency with our accurate typing test. Upon completion, you'll instantly receive
            an
            overview of your performance in the form of an informative bar chart. It's the perfect way to see where you
            stand and how you can grow.</p><br/>
          <h2>Data Storage and Access:</h2>
          <p>Understanding the importance of progress tracking, [Your Website Name] offers the option to save your
            scores.
            This way, you can always revisit your achievements and monitor improvements.</p><br/>
          <h2>Our Mission</h2>
          <p>Our mission is simple: to make typing fun, educational, and measurable. [Your Website Name] is not just a
            platform for learning but also for growing and achieving success in your typing skills.</p>
        </div>
        <div className="about-text">
          <h1>Proud School Project</h1>
          <p>We're excited to share that Charlie, the creator of Typrr, developed this website as part of his school's
            final
            project and successfully graduated! This is the result of dedication, creativity, and hard work.</p>
